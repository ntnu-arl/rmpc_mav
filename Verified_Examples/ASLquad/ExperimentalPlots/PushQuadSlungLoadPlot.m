...
plot(PLOT_DATASET.time,-PLOT_DATASET.position.z.resp+.9,'r','LineWidth',1); grid on;
...
linkaxes(ha,'x');
%%
export_fig PushQuadSlungLoad1.eps -eps -transparent -m2 -a2 