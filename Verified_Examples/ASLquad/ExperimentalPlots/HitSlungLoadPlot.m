...
ha(2) = subplot(4,1,2);
plot(PLOT_DATASET.time,-PLOT_DATASET.position.z.resp + 1,'r','LineWidth',1); grid on;
plot(PLOT_DATASET.time(points_circle), -PLOT_DATASET.position.z.resp(points_circle)+1,'ro','LineWidth',2);
...
%%
export_fig HitSlungLoad1.eps -eps -transparent -m2 -a2 
%%
export_fig HitSlungLoad1.png -png -transparent -m2 -a2 
