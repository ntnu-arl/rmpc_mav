...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_TTR_mdl_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Robust_MPC_Library_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_TTR_mdl_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_Robust_MPC_Library_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_TTR_mdl_autoinheritance_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Robust_MPC_Library_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "TTR_mdl") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_TTR_mdl_autoinheritance_info(nlhs,plhs,3,newRhs);
  }

  if (strcmp(machineName, "Robust_MPC_Library") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Robust_MPC_Library_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_TTR_mdl_third_party_uses_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Robust_MPC_Library_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "TTR_mdl") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_TTR_mdl_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
  ...
  if (strcmp(machineName, "Robust_MPC_Library") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Robust_MPC_Library_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_TTR_mdl_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_Robust_MPC_Library_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "TTR_mdl") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_TTR_mdl_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
  ...
  if (strcmp(machineName, "Robust_MPC_Library") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Robust_MPC_Library_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_TTR_mdl_method_dispatcher(SimStruct *S, unsigned int
  chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_Robust_MPC_Library_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"TTR_mdl")) {
    return(sf_TTR_mdl_method_dispatcher(simstructPtr,chartFileNumber,specsCksum,
            method,data));
  }

  if (!strcmp(machineName,"Robust_MPC_Library")) {
    return(sf_Robust_MPC_Library_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void TTR_mdl_terminator(void);
extern void Robust_MPC_Library_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    TTR_mdl_terminator();
    Robust_MPC_Library_terminator();
...
extern void TTR_mdl_initializer(void);
extern void Robust_MPC_Library_initializer(void);
extern void TTR_mdl_register_exported_symbols(SimStruct* S);
extern void Robust_MPC_Library_register_exported_symbols(SimStruct* S);
extern void TTR_mdl_debug_initialize(struct SfDebugInstanceStruct*);
extern void Robust_MPC_Library_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  TTR_mdl_register_exported_symbols(S);
  Robust_MPC_Library_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      TTR_mdl_debug_initialize(sfGlobalDebugInstanceStruct);
    }
